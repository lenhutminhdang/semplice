// This slider code from: https://codepen.io/mmadeira/pen/PQXdMp
...
const Slider = {
  init() {
    ...
    this.slideInnerEl.addEventListener(
      "transitionend",
      this.onSliderTransitionEnd.bind(this)
    );
  ...
  onSliderTransitionEnd() {
    ...
    this.sliderItemsEl.forEach((element) =>
  ...
  moveSlider() {
    ...
    this.sliderItemsEl[currentPage + -1 * signal].classList.add(
      ANIMATING_CLASS
    );
